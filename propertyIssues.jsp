<%-- 
    Document   : propertyIssues
    Created on : 23 Mar, 2018, 7:46:14 AM
    Author     : acer
--%>
        ...
        <form name="frm_pending">
                   ...
                   <table class="table table-hover" align="center" border="2">
                     ...
                     <%
                         ...
                         int i=1;
    String str="select * from tbl_petitioner p inner join tbl_petition e inner join tbl_advocate a inner join tbl_judge u on p.pet_id=e.pet_id and e.adv_id=a.adv_id and u.court_id=a.court_id where e.jud_approve_status=1 and e.case_id=3 and u.jud_id='"+session.getAttribute("judid")+"'";
...
//      session.setAttribute("peti", rs.getString("pet_id"));
     ...
     <tr>
        ...
        <td><%=des%></td>
         ...
         <td><a href="Divorce.jsp?pid=<%=rs.getString("pet_id")%>&&advid=<%=rs.getString("adv_id")%>">Set Date And Time</a></td>
